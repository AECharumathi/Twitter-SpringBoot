package com.greatlearning.twitter.config;
...
public class SwaggerConfig {
    ...
    public Docket customImplementation(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .apiInfo(getApiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.greatlearning.twitter"))
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfo("REST Api Documentation",
                ...
                "1.0",
                "urn:tos",
                new Contact("Developer", "Charumathi A E", "charumathielangovan96@gmail.com"),
